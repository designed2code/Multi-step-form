...
export const SelectYourPlan = ({ footerBtn }) => {
  return (
    <>
      <div>
        <div className="mainContentContainer">
          <Heading
            ...
            subHeadingText={"You have the option of monthly or yearly billing."}
          />
          ...
          <div className="planDurationContainer">
            <div className="planDuration">
              <h1 className="activePlan">Monthly</h1>
              <CustomSwitch />
              <h1 className="inactivePlan">Yearly</h1>
            </div>
          </div>
        </div>
        <div style={{ marginTop: "116px" }}>{footerBtn}</div>
      </div>
    </>
  );
};
...
const Arcade = () => {
  return (
    <div className="planContainerActive">
      <div className="planContent">
        ...
        <div className="titleWithPricing">
          <h1>Arcade</h1>
          <p>$9/mo</p>
        </div>
      </div>
...
const Advanced = () => {
  return (
    <div className="planContainerInActive">
      <div className="planContent">
        <div className="planIcon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
